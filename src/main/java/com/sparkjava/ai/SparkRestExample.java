...
import red.reid.com.WebAPIServer;
...
public class SparkRestExample {
    ...
    public static void main(String[] args) {
        ...
        before("/*",((request, response) -> logger.info("Receive api call")));
        ...
        get("/users", (request, response) -> {
            ...
            return gson.toJson(new StandardResponse(StatusResponse.SUCCESS, new Gson().toJsonTree(userService.getUsers())));
        });
